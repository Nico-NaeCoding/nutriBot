  ...
  return (
    <Container>
      ...
      <Herosection>
        ...
        <Subtitle>
          개인 맞춤형 영양 분석과 식단 개선 제안을 통해 더 건강한 식습관을
          만들어가세요.
        </Subtitle>
        <CustomButton
          ButtonMessage="시작하기 >"
          ButtonOnClick={handlechatButton}
        />
      </Herosection>
      ...
      <WhySection>
        ...
        <p>
          나의 잘못된 식습관을 함께 고민하며 더 성장한 나의 모습을 기대해볼 수
          있으니까!
        </p>
        ...
        <Stepscontainer>
          <Step>
            ...
            <StepContent>
              ...
              <Stepdescription>
                성별, 나이, 키, 몸무게와 같은 기본 정보를 입력해 개인 맞춤
                기준을 설정합니다.
              </Stepdescription>
            </StepContent>
          </Step>
          ...
          <Step>
            ...
            <StepContent>
              ...
              <Stepdescription>
                오늘 섭취한 음식이나 계획 중인 식단에 대해 자연스럽게 대화하듯
                알려주세요.
              </Stepdescription>
            </StepContent>
          </Step>
          ...
          <Step>
            ...
            <StepContent>
              ...
              <Stepdescription>
                AI가 분석한 영양 상태와 개선점을 확인하고 더 나은 식습관을
                실천해보세요.
              </Stepdescription>
            </StepContent>
          </Step>
